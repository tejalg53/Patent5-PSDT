...
if not results:
    ...
    rows = [
        ...
        ("Communication Messages (mean per run)", baseline_means["communication_messages"],
        proposed_means["communication_messages"], cmp["communication_messages"]["reduction_pct"], "% reduction"),
        ...
        ("PT Violations (count, mean per run)", baseline_means["violation_events"],
        proposed_means["violation_events"], cmp["violation_events"]["difference"], "difference"),
        ("Mean PSM", baseline_means["mean_psm"], proposed_means["mean_psm"],
         cmp["mean_psm"]["difference"], "difference"),
        ("Mean PE (ms, mean per run)", baseline_means["mean_pe"], proposed_means["mean_pe"],
        cmp["mean_pe"]["difference"], "difference"),
